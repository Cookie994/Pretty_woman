...
<body class="bg-light">
    ...
    border-top: 1px solid rgb(211, 211, 211);">
       <a class="navbar-brand mr-0" href="index_en.php"><img src="img/en.png" alt="enIcon" class="w-50"></a>
        ...
        <div class="my-5 py-5">
            <div class="row justify-content-center pb-4">
               ...
               <div class="col-xl-6 ml-xl-3">
                   <h5 style="font-size: 25px">U našoj ponudi možete pronaći:</h5>
                   <div class="row mt-4">
                       <ul class="list-unstyled col-4">
                            <li>Sve vrste frizura</li>
                            <li>Pletenice</li>
                            <li>Flamobjaž</li>
                            <li>Balajaž</li>
                            <li>Ombre</li>
                        ...
                        <ul class="list-unstyled col-4">
                            ...
                            <li>Nadogradnja kose</li>
                            <li>Nadogradnja kose brazilskom metodom</li>
                            <li>Šišanje</li>
                       </ul>
                       <ul class="list-unstyled col-4">
                            <li>Feniranje</li>
                            <li>Farbanje</li>
                            <li>Brazilsko ispravljanje kose</li>
                            <li>Mini-val</li>
                            <li>Talasi</li>
                            <li>Lokne</li>
                       </ul>
